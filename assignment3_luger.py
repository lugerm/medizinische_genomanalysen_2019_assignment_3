...
class Assignment3:
    ...
    def get_num_variants_with_mutationtaster_annotation(self):
        ...
        :return:
        '''
        variants_mutationtaster = 0
        for i in self.annotation_result_json:
            if 'dbnsfp' in i:
                if 'mutationtaster' in i['dbnsfp']:
                    variants_mutationtaster += 1
        print("Number of variants with mutationtaster annotation: ", variants_mutationtaster)
    ...
    def get_num_variants_non_synonymous(self):
        ...
        :return:
        '''
        variants_nonsynonymous = 0
        for i in self.annotation_result_json:
            if 'cadd' in i:
                key, value = "consequence", "NON_SYNONYMOUS"
                if key in i['cadd'] and value == i['cadd']['consequence']:
                    variants_nonsynonymous += 1
        print("Number of variants non synonymous:                 ", variants_nonsynonymous)
...
#      HBA1
#      LUC7L
#Number of variants modifier:                        4
#Number of variants with mutationtaster annotation:  5
#Number of variants non synonymous:                  3
#-----------------------------------------------------
